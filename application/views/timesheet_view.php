...
location.replace('<?php echo base_url();?>timesheet/detailproject/'+id);
    ...
    //       "bSortable": false,
    //       "bSortClasses": true,
    //       "sAjaxSource": '<?php echo base_url(); ?>timesheet/timesheettable/'+id,
    // //            "fnServerParams": function (aoData) {
    // //                aoData.push({'name': 'tug_id', 'value': tug},
    // //                {'name': 'datefrom', 'value': datefrom},
    // //                {'name': 'dateto', 'value': dateto},
...
function detaildokumentasi(project_id){
  $.ajax({
      type: 'post',
      url: '<?php echo base_url(); ?>timesheet/dokumentasi/' + project_id,
//            data: 'item_id=' + id + '&hour=' + hour,
      success: function (msg) {
          var data = JSON.parse(msg);
          // $('#itemnametable').text(data.name);
          $('#setdokumentasi').html(msg);
...
//                $('#addModal').modal('show');
    ...
    <div class="row" id="divrowproject">
        <div class="col-lg-12 col-xs-12" id="divdataproject">
            <h4>Project</h4>
            <div id="divtug">
    ...
    <div class="row" id="divrowtimesheet">
        <div class="col-lg-12 col-xs-12" id="divdataproject">
          <ul class="nav nav-tabs" role="tablist">
             <li role="presentation" class="active"><a href="#feature" aria-controls="feature" role="tab" data-toggle="tab">Feature</a></li>
   ...
   //     }
             ...
             <div role="tabpanel" class="tab-pane" id="calender">...</div>
